...
- Publish ERC-7730 descriptors for the current OTCRegistry deployments so supported wallets can show human-readable signing prompts. Draft descriptors and reference tests live under `erc7730/otcregistry/` before upstream submission.
